...
- **Passo 1:** Importe o arquivo `jm_servicos.sql` no phpMyAdmin para criar o banco de dados e as tabelas.
- **Passo 2:** Coloque a pasta do projeto no diretório do seu servidor local (ex: `htdocs` no XAMPP).
- **Passo 3:** Acesse o sistema pelo navegador (ex: `http://localhost/sistema_ordens_jm`).
- **Passo 4:** Para testar a Dashboard e as funcionalidades, utilize o usuário de teste que já está cadastrado no banco:
  - **Email:** teste@jm.com
  - **Senha:** 123456
